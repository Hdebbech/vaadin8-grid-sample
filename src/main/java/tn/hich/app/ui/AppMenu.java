...
import tn.hich.app.ui.views.DatasetView;
import tn.hich.app.ui.views.View2;
import tn.hich.app.ui.views.View3;
...
public class AppMenu extends CustomComponent {
	...
	private Component buildMenuItems() {
		...
		navButton1 = addItem(DatasetView.VIEW_NAME, DatasetView.ICON);
		navButton2 = addItem(View2.VIEW_NAME, View2.ICON);
		navButton3 = addItem(View3.VIEW_NAME, View3.ICON);
		navButton4 = logOutButton("Log Out", VaadinIcons.SIGN_OUT);
	...
	private Button logOutButton(String caption, VaadinIcons icon){
		Button gv = new Button();
		gv.setIcon(icon);
		gv.setPrimaryStyleName("valo-menu-item");
		gv.setCaption(caption);
